...
export function translateUnit(unit: sol.SourceUnit): string[] {
    ...
    unit.walk((nd) => {
        ...
        if (nd instanceof sol.SourceUnit) {
            ...
            args = translateVals(nd.anonymous, nd.name, nd.vParameters);
        } else if (nd instanceof sol.StructuredDocumentation) {
            args = translateVals(nd.text);
            ...
            args = translateVals(nd.vEventCall);
